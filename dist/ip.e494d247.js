...
function mineIp(g) {
  var cardBasligi = document.createElement("div");
  ...
  ulke.textContent = "".concat(g.ülke, " (").concat(g.ülkeKodu, ")");
  var enlemBoylam = document.createElement("p");
  info.appendChild(enlemBoylam);
  enlemBoylam.textContent = "Enlem: ".concat(g.enlem, " Boylam: ").concat(g.boylam, ")");
  var city = document.createElement("p");
  info.appendChild(city);
  city.textContent = "\u015Eehir: ".concat(g.şehir);
  var time = document.createElement("p");
  info.appendChild(time);
  time.textContent = "Saat dilimi: ".concat(g.saatdilimi);
  var para = document.createElement("p");
  info.appendChild(para);
  para.textContent = "Para birimi: ".concat(g.parabirimi);
  var isp = document.createElement("p");
  info.appendChild(isp);
  isp.textContent = "ISP: ".concat(g.isp);
  return cardBasligi;
}
